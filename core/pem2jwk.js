...
var pubFromPrivate = function(privateValue, curveOid) {
    var G = oidToG(curveOid);
    var d;
    if (privateValue instanceof BN) {
        d = privateValue;
    } else {
        d = new BN(privateValue, 16);
    }
...
var pkcs8ToJwk = function(pkcskey, callback) {
    ...
    generateJwk(decoded.body.namedCurve, decodedkey.key, pubFromPrivate(decodedkey.key, decoded.body.namedCurve), callback);
};
...
//module.exports.pkcs8ToJwk = pkcs8ToJwk;